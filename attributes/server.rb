...
if kernel['machine'] =~ /x86_64/
  ...
  default['sql_server']['server']['url']          = 'http://care.dlservice.microsoft.com/download/5/2/9/529fef7b-2efb-439e-a2d1-a1533227cd69/SQLEXPR_x64_ENU.exe'
  ...
  default['sql_server']['server']['url']          = 'http://care.dlservice.microsoft.com/download/5/2/9/529fef7b-2efb-439e-a2d1-a1533227cd69/SQLEXPR_x86_ENU.exe'
